...
class BuilderTest extends TestCase
{
    ...
    public function testCall()
    {
        ...
        $this->assertEquals('#id { box-shadow: 10px 10px 10px #000000; display: flex; align-items: items-center; }', $builder);
    }
    ...
    public function testToString()
    {
        ...
        $this->assertEquals('#id { box-shadow: 10px 10px 10px #000000; display: flex; align-items: items-center; }', (string)$builder);
    }
    ...
    public function testInline()
    {
        ...
        $builder->all('initial')->display('flex');
